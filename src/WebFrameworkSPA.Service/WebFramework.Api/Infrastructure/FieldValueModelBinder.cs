...
namespace Web.Infrastruture
{
    public class FieldValueModelBinder : IModelBinder
    {
        ...
        public bool BindModel(HttpActionContext actionContext, ModelBindingContext bindingContext)
        {
            ...
            var maxRecurseLimit = ConfigurationManager.AppSettings["ModelBinderMaxRecursionLimit"] == null ? null : ConfigurationManager.AppSettings["ModelBinderMaxRecursionLimit"].ToString();
