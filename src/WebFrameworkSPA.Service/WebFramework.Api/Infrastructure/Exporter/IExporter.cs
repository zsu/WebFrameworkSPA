...
namespace Web.Infrastructure
{
    public interface IExporter
    {
        ...
        string Export(string reportName, IDataReader data, List<string> includeProperties, List<string> excludeProperties, bool addTimeStamp);
        /// <summary>
        ...
        string Export(string reportName, IDataReader data, string outputFilePath, List<string> includeProperties, List<string> excludePropertie, bool addTimeStamp);
        /// <summary>
        /// Generate report in memory
        /// </summary>
        /// <param name="reportName">Report key</param>
