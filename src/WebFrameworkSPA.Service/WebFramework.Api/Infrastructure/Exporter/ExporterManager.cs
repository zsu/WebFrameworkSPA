...
namespace Web.Infrastructure
{
    ...
    {
        public static string Export(string reportName, ExporterType exportType, IDataReader data, List<string> includeProperties = null, List<string> excludeProperties = null, bool addTimeStamp = true)
        {
            IExporter exporter;
            switch (exportType)
            {
        ...
        public static string Export(string reportName, ExporterType exportType, IDataReader data, string outputFilePath, List<string> includeProperties = null, List<string> excludeProperties = null, bool addTimeStamp = true)
        {
            IExporter exporter;
            switch (exportType)
            {
