...
namespace BrockAllen.MembershipReboot.Nh
{
    public class UserRole
    {
        ...
        public static bool operator ==(UserRole lhs, UserRole rhs)
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (!this.IsTransient() && !other.IsTransient())
            {
                ...
                if (userAccountId == otherAccountId && roleId == otherRoleId)
                {
            ...
            else
            {
                unchecked
                {
                    ...
                    this.cachedHashcode = (hashCode * HashMultiplier)
                                          ^ userAccountId.GetHashCode() + (hashCode * HashMultiplier)
                                          ^ roleId.GetHashCode();
                }
            }
        ...
        protected bool IsTransient()
        {
            ...
            return this.Account == default(NhUserAccount);
        }
