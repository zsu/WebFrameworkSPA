...
namespace App.Common.TypeFinder
{
    /// <summary>
    /// A class that finds types needed by application by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether application should iterate assemblies in the app domain when loading Nop types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that assemblies arn't investigated (e.g. by not including something like "^Nop|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the application factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into applicaton.</returns>
