...
namespace BrockAllen.MembershipReboot
{
        ...
        where TAccount : UserAccount
    {
        ...
        public virtual TAccount CreateAccount(string username, string password, string email, string firstname, string lastname)
        { return CreateAccount(null, username, password, email, firstname, lastname); }
        //Changed by: Zhicheng Su
        public virtual TAccount CreateAccount(string tenant, string username, string password, string email,string firstname, string lastname)
        {
            if (Configuration.EmailIsUsername)
            {
                Tracing.Verbose("[UserAccountService.CreateAccount] applying email is username");
        ...
        public virtual TAccount CreateAccountWithTempPassword(string tenant, string username, string password, string email,string firstname, string lastname)
        {
            ...
            this.AddEvent(new PasswordGeneratedEvent<TAccount> { Account = account, InitialPassword = password, VerificationKey=key});
            return account;
        }
 
        //Changed by: Zhicheng Su
        protected string Init(TAccount account, string tenant, string username, string password, string email)
        {
