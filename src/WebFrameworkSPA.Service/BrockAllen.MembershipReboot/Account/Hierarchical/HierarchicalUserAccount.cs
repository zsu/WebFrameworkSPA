...
namespace BrockAllen.MembershipReboot.Hierarchical
{
    public class HierarchicalUserAccount : UserAccount
    {
        ...
        public HashSet<PasswordHistory> PasswordHistoryCollection = new HashSet<PasswordHistory>();
        public virtual IEnumerable<PasswordHistory> PasswordHistories
        {
            get { return PasswordHistoryCollection; }
        }
        public virtual void AddPasswordHistory(PasswordHistory item)
        {
            PasswordHistoryCollection.Add(item);
        }
        public virtual void RemovePasswordHistory(PasswordHistory item)
        {
            PasswordHistoryCollection.Remove(item);
        }
    }
}
