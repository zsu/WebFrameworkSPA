(function () {
     ...
     */
    function Controller($scope, $location, signalRSubscribe, toast, dialog, $translate, $stateParams,common, personalization, confirmemailApi) {
        $scope.confirmEmailModel = {};
        $scope.confirmEmailModel.Password = "";
        $scope.confirmEmailModel.Key = $stateParams.id;
        $scope.confirmEmail = function () {
            return confirmemailApi.confirmEmail($scope.confirmEmailModel)
            .then(function (data) {
    ...
    app.controller("ConfirmEmailController",
        ["$scope", "$location", "signalRSubscribe", "toast", "dialog", "$translate", "$stateParams", "common", "personalization", "confirmemailApi", Controller]);
})();
